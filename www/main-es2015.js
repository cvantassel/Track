...
const routes = [
    ...
    {
        path: 'project/:id',
        loadChildren: () => Promise.all(/*! import() | project-project-module */[__webpack_require__.e("common"), __webpack_require__.e("project-project-module")]).then(__webpack_require__.bind(null, /*! ./project/project.module */ "./src/app/project/project.module.ts")).then(m => m.ProjectPageModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, meta) {
        this.platform = platform;
        this.splashScreen = splashScreen;
        this.statusBar = statusBar;
        this.meta = meta;
        this.meta.addTag({ name: 'theme-color', content: '#504D55' });
        this.initializeApp();
    }
    initializeApp() {
...
module.exports = __webpack_require__(/*! /home/caskla/bin/ionic/track/src/main.ts */"./src/main.ts");
